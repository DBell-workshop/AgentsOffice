...
前往 **http://localhost:5173/static/office/**

你會看到像素風辦公室，點擊底部 Agent 狀態列開始體驗！
...
AgentsOffice 採用**開放核心 (Open Core)** 模式：

| | 免費版 | 專業版 | 團隊版 |
|--|--------|--------|--------|
| **Agent 數量** | 2 個自訂 + 調度員 | 無限 | 無限 + 自訂 Skill |
| **RPG 辦公室** | ✅ | ✅ | ✅ |
| **LLM 模型** | 自帶 Key | 自帶 Key | 自帶 Key |
| **資料管理** | ✅ | ✅ | ✅ |
| **成本追蹤** | ✅ | ✅ | ✅ |
| **自訂 Skill** | - | ✅ | ✅ |
| **資料匯出** | - | ✅ | ✅ |
