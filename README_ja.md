...
### 🤖 柔軟な Agent システム
- **無料版**: カスタム Agent 2 体 + ディスパッチャー 1 体
...
```bash
cp .env.example .env
# .env を編集し、LLM の API Key を入力してください
```
...
**http://localhost:5173/static/office/** にアクセス

ドット絵風オフィスが表示されます。画面下部の Agent ステータスバーをクリックして体験を始めましょう！
